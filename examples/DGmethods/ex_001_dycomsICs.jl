# Simone's most up-to-date Dycoms
# https://raw.githubusercontent.com/climate-machine/CLIMA/sm/diagnostics/test/DGmethods/compressible_Navier_Stokes/ex_001_dycoms.jl
using MPI
using CLIMA
