...
#SBATCH --job-name=aRH100sadb
#SBATCH --time=100:00:00
#SBATCH --output=log_bcwave_hier_rel600.out
#SBATCH --ntasks=1
...
RUNNAME="hier_RH100_q_active_SAdb_rel600"

# Change if CLIMA and VizCLIMA not saved in $HOME
CLIMA_HOME='/central/groups/esm/lenka/ClimaTests2/ClimateMachine_100RH_active_SAdebug.jl'
...
EXPERIMENT=$CLIMA_HOME'/experiments/AtmosGCM/moist-baroclinic-wave.jl'
VIZCLIMA_SCRIPT=$VIZCLIMA_HOME'/src/scripts/hier_analysis_bcwave.jl'
