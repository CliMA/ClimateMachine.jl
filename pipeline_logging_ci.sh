...
RUNNAME="hier_init_q_passive"

# Change if CLIMA and VizCLIMA not saved in $HOME
CLIMA_HOME='/central/groups/esm/lenka/ClimaTests2/ClimateMachine_initmoist_passive.jl'
