...
function source!(
    ...
    source.FL = m.NPP*0.75  - m.a_31*state.FL  - aux.FLk_1# net rate of incoming carbon into B - outgoing carbon into S
    source.SL = m.NPP*0.25 - m.a_32*state.SL -  m.a_42*state.SL - aux.SLk_2 # net rate of incoming carbon into S - outgoing carbon to ...?
    source.FSOC =  m.a_35*state.PSOC + m.a_34*state.SSOC + m.a_32*state.SL + m.a_31*state.FL  - m.a_43*state.FSOC - m.a_53*state.FSOC - aux.FSOCk_3 # net rate of incoming carbon into B - outgoing carbon into S
    source.SSOC =  m.a_42*state.SL + m.a_43*state.FSOC - m.a_34*state.SSOC - m.a_54*state.SSOC - aux.SSOCk_4 # net rate of incoming carbon into S - outgoing carbon to ...?
    source.PSOC =  m.a_53*state.FSOC + m.a_54*state.SSOC - m.a_35*state.PSOC - aux.PSOCk_5 # net rate of incoming carbon into B - outgoing carbon into S
end;
