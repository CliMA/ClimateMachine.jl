...
@testset "Snow Model" begin
    ...
    Q_surf = (t) -> eltype(t)(-9.0*cos(2.0*π/3600/24*t))
   ...
   # z = get_z(solver_config.dg.grid; rm_dupes = true);
    ...
    z = 0:0.01:depth    
    # Form of analytic solution depends on phase convention of input radiation
   ...
   #very specifically testing equilibrium gradient  
...
@testset "Snow Model Force Restore" begin
    ...
    sources = (FluxDivergence{FT}(),ForceRestore{FT}(),)
    ...
    # this analytic solution makes assumptions about the phaes of the radiation
    function analytic(p, Q, a, tbar,z,t)
        κ = p.κ_snow
        ρ = p.ρ_snow
        z_snow = p.z_snow
    ...
    gif(anim, "snow_fr_incorrect_ic.gif", fps = 6)
    
end


@testset "ERA5 Force Restore" begin
