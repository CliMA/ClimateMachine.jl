abstract type Coriolis <: Forcing end

@Base.kwdef struct DeepShellCoriolis{FT} <: Coriolis
    Ω :: FT # s⁻¹
end

@Base.kwdef struct ThinShellCoriolis{FT} <: Coriolis
    Ω :: FT # s⁻¹
end

@Base.kwdef struct BetaPlaneCoriolis{FT} <: Coriolis
    f₀ :: FT # s⁻¹
    β  :: FT # s⁻¹m⁻¹
end
