...
using ClimateMachine.Mesh.Grids:
    DiscontinuousSpectralElementGrid, min_node_distance
...
spl = getspline(joinpath("images", "clima_logo.png"), (0, 10000), (0, 10000))
...
function run(
    ...
    model =
        DryAtmosModel{dim}(FlatOrientation(), problem; ref_state = ref_state)
