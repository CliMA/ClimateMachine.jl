...
function main(mpicomm, DFloat, topl::AbstractTopology{dim}, N, timeend,
  ...
  ark = ARK548L2SA2KennedyCarpenter(nonlin_spacedisc, lin_spacedisc, lin_solve!,
                                    Q; dt = dt, t0 = 0)
  #=
  ark = LSRK54CarpenterKennedy(nonlin_spacedisc, Q; dt = dt, t0 = 0)
  =#
...
let
  ...
  expected_error[1,3] = 3.2924195502890023e-03
  expected_error[2,1] = 1.8059108422662815e+00
  expected_error[2,2] = 2.1955161886731539e-01
  expected_error[2,3] = 1.0411544575625126e-02
