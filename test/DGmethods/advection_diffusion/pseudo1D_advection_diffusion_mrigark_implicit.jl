...
let
    ...
    expected_result[3, 4, Float64] = 4.5797015138785234e-06
    ...
    expected_result[3, 2, Float32] = 1.0332707315683365e-02
    expected_result[3, 3, Float32] = 5.4524099687114358e-04
    # This is near roundoff so we will not check it
