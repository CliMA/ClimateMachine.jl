...
using Printf
using Dates
using CLIMA.ColumnwiseLUSolver: SingleColumnLU, ManyColumnLU, banded_matrix, banded_matrix_vector_product!
...
#  @testset begin
    ...
    Δx, Δy, Δz = 40, 40, 20
    xmin, xmax = FT(0), FT(1000)
    ymin, ymax = FT(0), FT(1000)
    zmin, zmax = FT(0), FT(2500)
