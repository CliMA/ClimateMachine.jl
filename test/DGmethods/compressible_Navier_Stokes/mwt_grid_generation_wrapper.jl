...
function run(mpicomm, ArrayType, dim, topl, N, timeend, DT, dt, C_smag, LHF, SHF, C_drag, zmax, zsponge)
  ...
  step = [0]
    ...
    mkpath("/home/yassine/yt-2T-drive/CLIMA-run/vtk-dycoms/")
    outprefix = @sprintf("/home/yassine/yt-2T-drive/CLIMA-run/vtk-dycoms/dycoms_%dD_mpirank%04d_step%04d", dim,
...
let
  ...
  topl,DT,dim,timeend,dt,polynomialorder,zmax=Generate_grid(Val(3),(50,50,20),Float64(0.02),1,mpicomm,4,((0,2000),(0,2000),(0,1500)),(true,true,false),((0,0),(0,0),(1,2))) 
