...
function run(mpicomm, ArrayType, 
  ...
  linearsolver = GeneralizedMinimalResidual(10, Q, 1e-5)
  ode_solver = ARK2GiraldoKellyConstantinescu(slow_dg, fast_dg, linearsolver, Q; dt = dt, t0 = 0,
                                           split_nonlinear_linear=true, schur=true)
