...
#=
    Test conditions:
        B = updraft_velocity, osmotic_coefficient, mass_fraction, water_molecular_mass, aerosol_density, M_a, water_density  
        updraft_velocity = number of ions the salt dissociates into within water → 3
        osmotic_coefficient = osmotic coefficient → 1
        mass_fraction = mass fraction of soluble material → ????
        water_molecular_mass = molecular weight of water → 18.01528 g/mol
        aerosol_density = density of the aerosol material → 1.77 g/cm^3
        M_a = molecular weight of aerosol material → 132
        water_density  = density of water → 1 g/cm^3
