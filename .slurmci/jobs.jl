[SlurmJob(`.slurmci/init.sh`) =>
 [SlurmJob(`.slurmci/cpu-test.sh`)
  ...
  SlurmJob(`.slurmci/cpu.sh test/DGmethods/compressible_Navier_Stokes/MWE_grid_stretching.jl`, ntasks=3)
  ...
  SlurmJob(`.slurmci/gpu.sh test/DGmethods/compressible_Navier_Stokes/MWE_grid_stretching.jl`, ntasks=3)
