[SlurmJob(`.slurmci/init.sh`) =>
 [SlurmJob(`.slurmci/cpu-test.sh`)
  ...
  SlurmJob(`.slurmci/cpu.sh test/DGmethods/Euler/isentropic_vortex_standalone_IMEX.jl`, ntasks=3)
  SlurmJob(`.slurmci/cpu.sh test/DGmethods/Euler/RTB_IMEX.jl`, ntasks=3)
  ...
  SlurmJob(`.slurmci/cpu.sh test/DGmethods/compressible_Navier_Stokes/MWE_external_topography.jl`, ntasks=3)
  ...
  SlurmJob(`.slurmci/gpu.sh test/DGmethods/compressible_Navier_Stokes/MWE_external_topography.jl`, ntasks=3)
