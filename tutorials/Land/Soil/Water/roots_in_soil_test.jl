...
using PlantHydraulics: need roots_flow!, create_grass #
...
plant_hs = create_grass(z_root, FT(0.5), soil_bounds, FT[0,1]) 

root_extraction(plant_hs, matric_potential);
root_extraction(plant_hs, matric_potential, FT(0));
#  with semicolen in the function defn
root_extraction(plant_hs, matric_potential; qsum=FT(0));
