...
for index in [1,2,3]
    ...
    wpf = WaterParamFunctions(FT; Ksat = Ksat, θ_r = θ_r, S_s = S_s)
    ...
    h_index =
        varsindex(vars_state(model, Prognostic(), FT), :surface, :height)
...
#plot!(ylim = [0,10.5])
#plot!(yticks = [0,0.0005,0.001,0.0015,0.002,0.0025])
