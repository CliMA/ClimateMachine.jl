# # [Density Current](@id EX-RTB-docs)
#
...
# dynamics of the clasical density current test by Straka 1993.
# We solve a flow in a
...
#    - Time integrator
#    - Sources
#    - Smagorinsky Coefficient S_smag
...
# This example of a Density Current can be classified as an initial value
...
# `julia --project /experiments/AtmosLES/densitycurrent.jl` will run the
