...
function LocalGeometry(polynomial::Val, vgeo::AbstractArray{T}, n::Integer, e::Integer) where {T}
...
"""
function resolutionmetric(g::LocalGeometry{T, Val{polyorder}}) where {T,polyorder}
