...
function update_auxiliary_state!(
    ...
    println(typeof(m))
    println("-------------------------------------------")
    println(typeof(Val(dim)))
    println("-------------------------------------------")
    println(typeof(Val(N)))
    println("-------------------------------------------")
    println(typeof(f!))
    println("-------------------------------------------")
    println(typeof(state_prognostic.data))
    println("-------------------------------------------")
    println(typeof(dg.state_auxiliary.data))
    println("-------------------------------------------")
    println(typeof(dg.state_gradient_flux.data))
    println("-------------------------------------------")
    println(typeof(t))
    println("-------------------------------------------")
    println(typeof(elems))
    println("-------------------------------------------")
    println(typeof(grid.activedofs))
    println("-------------------------------------------")
    println("-------------------------------------------")
    println("-------------------------------------------")
    if diffusive
