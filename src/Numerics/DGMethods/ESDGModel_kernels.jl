...
@kernel function esdg_volume_tendency_naive_ξ1ξ2!(
    balance_law::BalanceLaw,
    ::Val{dim},
    ::Val{polyorder},
    volume_numerical_flux_first_order,
...
@kernel function esdg_volume_tendency_naive_ξ3!(
    balance_law::BalanceLaw,
    ::Val{dim},
    ::Val{polyorder},
    volume_numerical_flux_first_order,
...
@kernel function esdg_volume_tendency_dir!(
    balance_law::BalanceLaw,
    ::Val{dir},
    ::Val{dim},
    ::Val{polyorder},
