...
Computes the reference element tendency using a two-point flux approximation of all derivatives.
"""
@kernel function fluxdiff_volume_tendency!(
    balance_law::BalanceLaw,
    ::Val{dir},
    ::Val{info},
