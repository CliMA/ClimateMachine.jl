...
@init @require CuArrays = "3a865a2d-5b23-5a0f-bc46-62713ec82fae" begin
    # split these off into separate files to avoid loading CUDA packages on non-GPU machines
    # rewrite to KernelAbstractions once generic framework figured out
    include("Interpolation_cuda.jl")
end
