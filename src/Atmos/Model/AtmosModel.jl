...
function calculate_dt(grid, atmos::AtmosModel, Courant_number)
    T = 290.0
    return Courant_number * min_node_distance(grid, VerticalDirection()) / soundspeed_air(atmos.param_set, T)
end
