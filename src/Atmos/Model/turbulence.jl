...
function atmos_init_aux!(::TurbulenceClosure, ::AtmosModel, aux::Vars, geom::LocalGeometry, Dx, Dy)
end
...
function atmos_init_aux!(::SmagorinskyLilly, ::AtmosModel, aux::Vars, geom::LocalGeometry, Dx, Dy)
...
function atmos_init_aux!(::Vreman, ::AtmosModel, aux::Vars, geom::LocalGeometry, Dx, Dy)
  aux.turbulence.Δ = lengthscale(geom)
end
...
function atmos_init_aux!(::AnisoMinDiss, ::AtmosModel, aux::Vars, geom::LocalGeometry, Dx, Dy)
  aux.turbulence.Δ = lengthscale(geom)
end
