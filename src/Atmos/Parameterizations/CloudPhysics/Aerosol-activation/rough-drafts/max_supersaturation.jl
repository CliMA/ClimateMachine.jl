...
function max_supersatuation(am)
    alpha = alpha_sic(am)
...
am = aerosol_model((accum_mode_seasalt, coarse_mode_ssanddust))
testoutput0 = critical_supersaturation(am)
println("This is critical_supersaturation: ", testoutput0)
testoutput1 = max_supersatuation(am)
println("This is the result of max_supersaturation: ", testoutput1)