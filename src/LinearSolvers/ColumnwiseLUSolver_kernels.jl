...
""" band_lu_knl!
@kernel function band_lu_knl!(A, ::Val{Nq}, ::Val{Nqi}, ::Val{Nqj}, ::Val{nstate},
...
""" band_forward_knl!
@kernel function band_forward_knl!(b, LU::AbstractArray{T,N}, ::Val{Nq}, ::Val{Nqj},
...
""" band_back_knl!
@kernel function band_back_knl!(b, LU::AbstractArray{T, N}, ::Val{Nq}, ::Val{Nqj},
                                ::Val{nstate}, ::Val{nvertelem}, ::Val{nhorzelem},
...
@kernel function knl_set_banded_data!(bl::BalanceLaw, ::Val{dim}, ::Val{N},
...
@kernel function knl_set_banded_matrix!(bl::BalanceLaw, ::Val{dim}, ::Val{N},
...
@kernel function knl_banded_matrix_vector_product!(bl::BalanceLaw, ::Val{dim}, ::Val{N},
                                                   ::Val{nvertelem}, ::Val{p}, ::Val{q},
