...
@inline function flux_first_order!(m::Continuity3dModel, flux::Grad,
                                    state::Vars, aux::Vars, t::Real, direction)
  @inbounds begin
...
boundary_state!(::CentralNumericalFluxSecondOrder, cm::Continuity3dModel,
                _...) = nothing
