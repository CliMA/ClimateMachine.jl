...
const astro_unit        = 1.4959787e11  # Astronomical unit (m)
...
const T0                = 273.16        # Triple point temperature (K)
...
const sat_vapor_press_0 = 611.657       # Saturation vapor pressure at T0 (Pa)
...
const orbit_semimaj     = 1*astro_unit  # Length of semimajor orbital axis (m)
