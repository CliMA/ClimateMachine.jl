...
while read -u3 -r line
  do
    ...
    mpiexec julia --project=$CLIMA_HOME $CLIMA_RUNFILE --diagnostics 0.5shours --monitor-courant-numbers 6shours --output-dir $CLIMA_NETCDF --checkpoint-at-end --checkpoint-dir $CLIMA_RESTART
    sleep 2
