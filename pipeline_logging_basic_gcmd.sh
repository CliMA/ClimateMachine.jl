...
mpiexec julia --project=$CLIMA_HOME $EXPERIMENT_FILE --diagnostics 24shours --monitor-courant-numbers 24shours --output-dir $CLIMA_NETCDF --checkpoint-at-end --checkpoint-dir $CLIMA_RESTART --sim-time=2592000
