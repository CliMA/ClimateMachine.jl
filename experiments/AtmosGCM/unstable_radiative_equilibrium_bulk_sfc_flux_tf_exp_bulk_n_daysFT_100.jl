...
function init_unstable_rad_equilibrium!(bl, state, aux, coords, t)
    ...
    q_0::FT = 0.00            ## Maximum specific humidity (default: 0.018)
...
function config_unstable_rad_equilibrium(FT, poly_order, resolution)
    ...
    #q_sfc = FT(0) #FT(22.45e-3)  # Surface specific humiity `[kg/kg]`
    ...
    model = AtmosModel{FT}(
        ...
        boundarycondition = (
            AtmosBC(
                ...
                #    (state, aux, t, normPu_int) -> (u_star*0.0 / normPu_int)^2,
                #)),
