...
function atmos_source!(
    ...
    q_tot_tendency = aux.lsforcing.Σqt_tendency + ∂qt∂z * w_s
...
"""
    MoistureTendency <: AbstractSource 
...
function atmos_source!(
    ...
    source.ρ -= state.ρ * w_s * dot(k̂, diffusive.moisture.∇q_tot)
    # GPU-friendly return nothing
    return nothing
end
