...
function config_risingbubble(FT, N, resolution, xmax, ymax, zmax)
    ...
    ode_solver = CLIMA.MISSolverType(
        ...
        slow_method = MIS2,
        fast_method = (dg,Q,nsteps) -> MultirateRungeKutta(:LSRK144NiegemannDiehlBusch, dg, Q, nsteps=nsteps),
...
function main()
    ...
    cbvtk = GenericCallbacks.EveryXSimulationSteps(20)  do (init=false)
        mkpath("./vtk-rtb/")
        outprefix = @sprintf("./vtk-rtb/risingBubbleBryanSplitMRK_mpirank%04d_step%04d",
