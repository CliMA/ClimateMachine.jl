...
#md # !!! note
#md #     This experiment setup assumes that you have installed CLIMA according to
#md #     the instructions on the landing page. We suggest that you attempt to run the
#md #     `runtests.jl` file in the main `CLIMA` directory to ensure that packages and
...
function config_risingbubble(FT, N, resolution, xmax, ymax, zmax)
    ...
    model = AtmosModel{FT}(
        AtmosLESConfigType,
        param_set;
        turbulence = SmagorinskyLilly(0.20),
