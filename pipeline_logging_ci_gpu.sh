...
#SBATCH --nodes=1
#SBATCH --job-name=bcwave_micro
#SBARCH --qos=debug
#SBATCH --time=00:10:00
#SBATCH --gres=gpu:1
#SBATCH --tasks-per-node=1
#SBATCH --output=log_bcwave_micro.out
...
RUNNAME="bulk_gpu_bcwave2"

# Change if CLIMA and VizCLIMA not saved in $HOME
CLIMA_HOME='/central/groups/esm/lenka/ClimaTests/cloned/ClimateMachine.jl'
...
EXPERIMENT=$CLIMA_HOME'/experiments/AtmosGCM/moist-baroclinic-wave-bulksfcflux.jl'
